...
const mostBlogs = (blogs) => {
  ...
  let amount_of_blogs = _.max(Object.values(composed_aggregate_object), o => composed_aggregate_object[o])
  //console.log(amount_of_blogs)

  function getKeyByValue(object, value) {
    return Object.keys(object).find(key => object[key] === value)
  }
  let name_of_author = getKeyByValue(composed_aggregate_object, amount_of_blogs)
